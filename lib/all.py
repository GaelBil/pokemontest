...
def main():
    ...
    main function
    """
    pokemon = pd.read_csv('/home/ao/Documents/Projet/pokemon/data/pokemonC.csv')
    combat = pd.read_csv('/home/ao/Documents/Projet/pokemon/data/combats.csv')
    ...
    dataframe.to_csv('/home/ao/Documents/Projet/pokemon/data/full.csv', index=False)
